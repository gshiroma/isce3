...
void Geocode<T>::geocode(const isce3::product::RadarGridParameters& radar_grid,
        ...
        float fill_value, bool flag_upsample_radar_grid,
        bool flag_apply_rtc,
...
void Geocode<T>::geocodeInterp(
        ...
        isce3::io::Raster& demRaster, float fill_value,
        ...
        for (int band = 0; band < nbands; ++band) {
            ...
            */
            ...
            _interpolate(rdrDataBlock, geoDataBlock, radarX, radarY,
                    ...
                    phase_screen_array, fill_value, rtc_min_value,
...
void Geocode<T>::_runBlock(
        ...
        double geogrid_upsampling, float fill_value,
